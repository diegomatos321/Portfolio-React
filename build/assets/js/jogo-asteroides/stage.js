...
export default class stage {
    constructor({ width: GAME_WIDTH, height: GAME_HEIGHT, parent }) {
        ...
        // Imagens
        Galeria.CarregarImagem("jogador_img", "/assets/imagens/jogo-asteroides/player.webp", this.init, this);
        Galeria.CarregarImagem("tiro_img", "/assets/imagens/jogo-asteroides/tiro.webp", this.init, this);
        Galeria.CarregarImagem("asteroide", "/assets/imagens/jogo-asteroides/asteroide.webp", this.init, this);

        // Audio
        Galeria.CarregarAudio("shoot_sound", "/assets/audio/jogo-asteroides/shoot_sound.mp3", this.init, this);
    ...
    redimensionar() {
        this.parentDimensions = this.parentElement.getBoundingClientRect();
        ...
        this.parentElement.style.width = novaLargura + "px";
