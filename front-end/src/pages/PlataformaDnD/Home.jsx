      ...
      <main>
        ...
        <section>
          <div>
            ...
            <Link to={`${url}/criar-ficha`}>Criar Ficha</Link>
          </div>
        </section>
        <section>
          <div>
            ...
            <Link to={`${url}/buscar-ficha`}>Buscar Ficha</Link>
          </div>
        </section>
        <section>
          <div>
            ...
            <Link to={`${url}/explorar/magias`}>Magias</Link>
          </div>
        </section>
        <section>
          <div>
            ...
            <Link to={`${url}/explorar`}>Explorar</Link>
          </div>
        </section>
        <section>
          <div>
            ...
            <Link to={`${url}/documentacao`}>Documentação</Link>
          </div>
        </section>
      </main>
    )
